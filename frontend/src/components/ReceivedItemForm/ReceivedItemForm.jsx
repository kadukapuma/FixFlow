...
const EMPTY_FORM = { item_name: "" };

function ReceivedItemForm({ initialValues, submitting, error, onSubmit, onCancel, submitLabel = "Save" }) {
        ...
        <form className="tenant-form tenant-form--1col" onSubmit={handleSubmit}>
            <label>
                ...
                <input
                    ...
                    placeholder="e.g. Charger, Box, Bill"
                    required
                />
            </label>
...
export default ReceivedItemForm;
